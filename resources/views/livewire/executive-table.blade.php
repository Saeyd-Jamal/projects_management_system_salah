...
<tr>
    ...
    <td>
        <x-form.input type="number" min="0" step="0.01" name="price"  wire:model="price" wire:input="total"/>
    </td>
    <td>
        <x-form.input type="number" min="0" step="0.01" name="total_ils" wire:model="total_ils" wire:input="update('total_ils', $event.target.value)"/>
    </td>
    <td>
        <x-form.input name="received"  list="received_list" :value="$executive->received" wire:input="update('received', $event.target.value)" />
    ...
    <td>
        <x-form.input type="number" min="0" step="0.01" name="amount_payments"  :value="$executive->amount_payments" wire:input="update('amount_payments', $event.target.value)"/>
    </td>
    <td>
