<tr>
    ...
    <td>
        <x-form.input name="item_name" list="items_list" :value="$allocation->item_name" required wire:input="update('item_name', $event.target.value)" />
    ...
    <td>
        <x-form.input type="number" min="0" name="quantity" wire:model="quantity" wire:input="total"/>
    </td>
    <td>
        <x-form.input type="number" min="0" step="0.01" name="price"  wire:model="price" wire:input="total" :value="$allocation->price" />
    </td>
    <td>
        <x-form.input type="number" min="0" step="0.01" name="total_dollar" wire:model="total_dollar" readonly/>
    </td>
    <td>
    ...
    <td>
        <x-form.input type="number" min="0" step="0.01" name="amount" wire:model="amount" readonly/>
    </td>
    <td>
        <x-form.input type="number" min="0" name="number_beneficiaries" :value="$allocation->number_beneficiaries" wire:input="update('number_beneficiaries', $event.target.value)"/>
    </td>
    <td>
