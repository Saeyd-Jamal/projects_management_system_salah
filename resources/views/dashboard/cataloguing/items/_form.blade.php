<div class="row">
    <div class="form-group col-md-3">
        <x-form.input type="text" name="name" label="اسم الصنف" :value="$item->name" placeholder="إملأ الاسم" autofocus required />
    </div>
...
<div class="form-group col-md-4">
    ...
    <x-form.input type="file" name="filesArray[]" label="رفع ملفات الصنف" multiple />
</div>
